#!/bin/bash
# Build and push Microservice 2 Docker image to ECR

set -e

# Get values from Terraform
cd "$(dirname "$0")/../terraform"
ECR_REPO=$(terraform output -raw ecr_repository_microservice2_url 2>/dev/null || echo "")
...
echo "Building and pushing Microservice 2 to ECR"
