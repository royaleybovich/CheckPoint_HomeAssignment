#!/bin/bash
# Script to deploy Microservice 1 to ECS
...
CLUSTER_NAME="${CLJECT_NAME:-${PROJECT_NAME}-cluster-${ENVIRONMENT}}"
SERVICE_NAME="${SERVICE_NAME:-${PROJECT_NAME}-ms1-${ENVIRONMENT}}"
TASK_DEFINITION_FAMILY="${TASK_DEFINITION_FAMILY:-${PROJECT_NAME}-ms1-${ENVIRONMENT}}"
ECR_REPOSITORY="${ECR_REPOSITORY:-${PROJECT_NAME}-microservice1}"
...
echo "=========================================="
echo "Deploying Microservice 1 to ECS"
echo "=========================================="
